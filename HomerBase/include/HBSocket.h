...
#ifdef APPLE
#define SOCKET_IO_BUFFER_SIZE                   		((System::GetTargetMachineType() != "x86") ? 256 * 1024 : 256 * 1024) // OS X accepts not more than 4MB!
#endif
#ifdef WINDOWS
#define SOCKET_IO_BUFFER_SIZE                   		((System::GetTargetMachineType() != "x86") ? 256 * 1024 : 256 * 1024) // Windows accepts almost every buffer limit
#endif
#ifdef LINUX
#define SOCKET_IO_BUFFER_SIZE                   		((System::GetTargetMachineType() != "x86") ? 262142 : 262142) // Linux accepts not more than 256KB - 2 bytes!
#endif
...
public:
    ...
    static std::string GetBestSourceIP(std::string pDestination);
