...
NGNSocketConnection::NGNSocketConnection(std::string pTarget, Requirements *pRequirements)
{
    ...
    if (!mIpv4only)
    {
        ...
        if(SPECIAL_PORT_RT_0 == mPort || SPECIAL_PORT_RT_1 == mPort || SPECIAL_PORT_DT_0 == mPort || SPECIAL_PORT_DT_1 == mPort)
        {
            ...
            LOG(LOG_VERBOSE,"%i is not the UDP encapsulation port  %i %i %i %i", mPort, SPECIAL_PORT_RT_0, SPECIAL_PORT_RT_1, SPECIAL_PORT_DT_0, SPECIAL_PORT_DT_1);
#endif
