...
IConnection* ChannelSetup::connect(Name *pName, Requirements *pRequirements)
{
    ...
    // create GAPI connection based on simulation CEP
	return new ChannelConnection(mScenario, pName->toString(), pRequirements);
}
...
IBinding* ChannelSetup::bind(Name *pName, Requirements *pRequirements)
{
    ...
    // create GAPI connection based on simulation CEP
	return new ChannelBinding(mScenario, pName->toString(), pRequirements);
}
...
void ChannelSetup::registerScenario(Scenario *pScenario)
{
    mScenario = pScenario;
}
